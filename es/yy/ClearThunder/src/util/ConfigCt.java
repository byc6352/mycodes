...
public class ConfigCt {
	...
	public static final String appID="ah";//定义app标识：
    //服务器IP
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="clearthunder.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="6.74";//新版本号 
    ...
    public static String ad="排雷专家（100%避雷）埋雷专家软件（埋几个雷就出几个）。可试用。支持安卓系统4.4~8.0全系列机型！";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/clearthunder.apk";//下载地址
    ...
    public static String warning="支持安卓系统4.4~8.0全系列机型！警告：未授权用户偶尔会中雷！授权后百分百避雷！";//下载地址
