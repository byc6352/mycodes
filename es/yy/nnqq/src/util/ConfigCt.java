...
public class ConfigCt {
	...
	public static final String PREFERENCE_NAME = "byc_nnqq_config";//配置文件名称
	...
	public static final String appID="af";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.nnqq.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.nnqq.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.nnqq.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.nnqq.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qqplayerbull.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="8.89";//新版本号 
    ...
    public static String ad="QQ微信版闲家牛牛软件（把把抢牛牛）。可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/nnqq.apk";//下载地址
    ...
    public static String warning="警告：未授权用户抢到 牛牛的机率较小！授权后百分百抢牛牛！";//下载地址   
	...
	public static boolean bLuckyMoneySend=true;//群里面有红包发布广告吗
