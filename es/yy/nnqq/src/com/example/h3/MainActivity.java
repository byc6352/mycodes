	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btConcel.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v){
				...
				//speeker.speak("QQ闲家抢牛牛介绍，红包来了，");
				//speeker.speak("手动点击红包，不要拆包。交给QQ闲家抢牛牛来分析来拆！");
				//System.exit(0);
			}
		...
		btStart.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				/*
				if(!getConfig().getREG()){
					Toast.makeText(MainActivity.this, "请购买正版，才能开启QQ闲家抢牛牛服务。", Toast.LENGTH_LONG).show();
					speaker.speak("请购买正版，才能开启QQ闲家抢牛牛服务。");
					return;
				}
				*/
				if(!QiangHongBaoService.isRunning()) {
					...
					Toast.makeText(MainActivity.this, "找到QQ闲家牛牛，然后开启QQ闲家抢牛牛服务。", Toast.LENGTH_LONG).show();
					speaker.speak("请找到QQ闲家牛牛，然后开启QQ闲家抢牛牛服务。");
				}else{
					Toast.makeText(MainActivity.this, "QQ闲家抢牛牛服务已开启！如需重新开启，请重启软件。", Toast.LENGTH_LONG).show();
					speaker.speak("QQ闲家抢牛牛服务已开启！如需重新开启，请重启软件。");
				}
				//2保存延时参数
			}
	...
	private BroadcastReceiver qhbConnectReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(Config.ACTION_QIANGHONGBAO_SERVICE_CONNECT.equals(action)) {
            	speaker.speak("已连接QQ牛牛服务！");
            } else if(Config.ACTION_QIANGHONGBAO_SERVICE_DISCONNECT.equals(action)) {
            	speaker.speak("已中断QQ牛牛服务！");
            }
        }
    };
