...
import com.byc.autoanswer.job.WechatAccessbilityJob;
/**
 * <p>Created by byc</p>
 * <p/>
 * 抢红包外挂服务
...
public class QiangHongBaoService extends AccessibilityService {
    ...
    public void onInterrupt() {
        ...
        Toast.makeText(this, "中断秒抢红包服务", Toast.LENGTH_SHORT).show();
    }
    @Override
    protected void onServiceConnected() {
        ...
        job=WechatAccessbilityJob.getJob();
        job.onCreateJob(service);
        Toast.makeText(this, "已连接秒抢服务", Toast.LENGTH_SHORT).show();
        //发送广播，已经连接上了
    ...
    public static void handeNotificationPosted(IStatusBarNotification notificationService) {
        ...
        WechatAccessbilityJob job=WechatAccessbilityJob.getJob();
        if(job == null) {
            return;
        }
