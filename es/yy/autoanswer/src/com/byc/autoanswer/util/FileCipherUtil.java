...
public class FileCipherUtil {  
     ...
     * 加密后的文件的后缀 
     */  
    public static final String CIPHER_TEXT_SUFFIX = ".dat";  
  
    /** 
     * 加解密时以32K个字节为单位进行加解密计算 
     */  
    private static final int CIPHER_BUFFER_LENGHT = 32 * 1024;  
    private static FileCipherUtil current;
    ...
    public static synchronized FileCipherUtil getFileCipher() {
        if(current == null) {
            current = new FileCipherUtil();
        }
        return current;
    }
}
