...
public class ConfigCt {
    ...
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.qqsuperrob.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qqsuperrob.xml";//服务器上文件名；
    ...
    public static String download="http://119.23.68.205/android/qqsuperrob.apk";//下载地址
    ...
    public static String warning="提示：授权后抢包速度翻倍！";//下载地址       
	...
	public static int NoRegUserSendADinterval=500;//最大未注册用户发广告间隔； 
