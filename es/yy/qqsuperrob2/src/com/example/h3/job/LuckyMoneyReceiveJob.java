...
public class LuckyMoneyReceiveJob {
    ...
    /*关闭窗体*/
    public void closeWindow(AccessibilityNodeInfo rootNode){
    	AccessibilityNodeInfo aNode=AccessibilityHelper.findNodeInfosByClassName(rootNode, "android.widget.ImageButton", 0, true);
    	if(aNode!=null){
    		AccessibilityHelper.performClick(aNode);
    	}
    }
    /*显示详细信息*/
    public  boolean unpackLuckyMoneyShow(AccessibilityNodeInfo rootNode){
    	...
    	//String sMoneyValue="";
		//if(Config.wv>=806)
		//	sMoneyValue=mReceiveInfo[0];
		//else
		//	sMoneyValue=mReceiveInfo[1];
