...
public class ConfigCt {
	...
	public static final String appID="ae";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.nn.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.nn.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.nn.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.nn.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="playerbull.xml";//服务器上文件名；
    ...
    public static String download="http://119.23.68.205/android/nn.apk";//下载地址
