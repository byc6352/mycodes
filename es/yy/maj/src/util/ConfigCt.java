...
public class ConfigCt {
	...
	public static final String appID="am";//定义app标识：
    //服务器IP
    ...
    public static String  new_version="2.22";//新版本号 
    ...
    public static String download="http://119.23.68.205/android/files/apk/maj.apk";//下载地址
