...
public class LuckyMoneyLauncherJob {
	...
	public static final int MAX_REG_AD=1000;//最大已注册用户发广告间隔； 
	public static final int MAX_NO_REG_AD=10;//最大未注册用户发广告间隔； 
	public int mIntAD=9;//广告计数器；
	public String mStrAD="排雷专家（100%避雷）埋雷专家软件（想要几个雷就出几个）。可试用。联系QQ1339524332微信：byc6354。下载地址：http://101.200.200.78/android/android.htm";
