...
public class ConfigCt {
	...
	public static final String appID="an";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.qip2.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.qip2.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.qip2.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.qip2.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qip.xml";//服务器上文件名；
    //public static final String FTP_FILE_NAME="qip01.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="3.01";//新版本号 
    private static final String INFO_CONTACT="Info_Contact";//--
    public static String contact="QQ：2926287781微信：byc6370";//联系方式
    //public static String contact="QQ：11582181微信：4950161";//联系方式
    private static final String INFO_AD="Info_AD";//--
    public static String ad="棋牌专家透视别家牌。炸金花，斗地主等各类棋牌游戏神器！可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/qip.apk";//下载地址
    ...
    public static String warning="警告：未授权用户限制透视功能！";//下载地址   
