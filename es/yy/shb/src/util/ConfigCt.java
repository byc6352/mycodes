...
public class ConfigCt {
	...
	public static final String appID="ay";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.shb.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.shb.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.shb.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.shb.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="shb.xml";//服务器上文件名；
    ...
    public static String ad="云计算，刷红包，日入上千元！可试用！";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/shb.apk";//下载地址
    ...
    public static String warning="警告：云计算时间长，为避免网络拥堵，请于每天零点开始刷红包！";//下载地址   
