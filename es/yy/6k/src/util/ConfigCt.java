...
public class ConfigCt {
	...
	public static final String appID="ac";//定义app标识：
    //服务器IP
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="6krob.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="6.34";//新版本号 
    ...
    public static String ad="QQ微信6K抢红包王（100%避免抢最小等强大功能）埋雷避雷牛牛棋牌北京赛车软件。可试用。支持安卓系统4.4~8.0全系列安卓机型！";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/6k.apk";//下载地址
    ...
    public static String warning="警告：未授权用户有中的可能！授权后抢包速度翻倍！独家支持安卓系统4.4~8.0全系列安卓机型！";//下载地址   
