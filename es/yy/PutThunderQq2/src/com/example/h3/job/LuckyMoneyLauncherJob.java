...
public class LuckyMoneyLauncherJob {
	...
	public String mStrAD=Config.ad+"联系"+Config.contact+"下载地址（复制到浏览器打开）："+Config.homepage;
    ...
    public void SendAD(AccessibilityNodeInfo rootNode){
    	...
    	if(Config.getConfig(context).getRegCode().equals(Config.RegCode))iMaxAD=MAX_NO_REG_AD;
