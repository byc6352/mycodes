...
public class Config {
	...
	public static final String PREFERENCE_NAME = "byc_putthunderqq2_config";//配置文件名称
    ...
    private static final String appID="au";//定义app标识：埋雷专家
    //服务器IP
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qqputthunder2.xml";//服务器上文件名；
    ...
    public static String download="http://119.23.68.205/android/putthunderqq2.apk";//下载地址
    ...
    public static String warning="警告：未授权软件内置广告！";//下载地址
    //-----------------------语音模块--------------------------------------------------
