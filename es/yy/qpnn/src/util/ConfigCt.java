...
public class ConfigCt {
	...
	public static final String appID="ao";//定义app标识：
    //服务器IP
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qpnn.xml";//服务器上文件名；
    //public static final String FTP_FILE_NAME="qpnn01.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="2.18";//新版本号 
    ...
    public static String ad="棋牌牛牛软件（把把抢牛牛）支持牛总管等各类牛牛游戏。可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/qpnn.apk";//下载地址
    ...
    public static String warning="警告：未授权用户抢到 牛牛的机率50%左右！授权后百分百抢牛牛！";//下载地址 
