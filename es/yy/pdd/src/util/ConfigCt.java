...
public class ConfigCt {
	...
	public static final String appID="dd";//定义app标识：
    //服务器IP
    ...
    //广播消息定义
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.byc.pdd.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.byc.pdd.ACCESSBILITY_CONNECT";
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.pdd.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.pdd.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.pdd.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.pdd.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="pdd.xml";//服务器上文件名；
    ...
    public static String contact="QQ：1339524332微信byc63520";//联系方式
    private static final String INFO_AD="Info_AD";//--
    public static String ad="拼多多砍价辅助软件（解放双手，全自动完成砍价任务）可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/pdd.apk";//下载地址
    ...
    public static String warning="警告：未授权用户需要计算拼多多数据！";//下载地址 
