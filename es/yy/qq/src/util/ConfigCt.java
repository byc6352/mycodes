...
public class ConfigCt {
	...
	public static final String appID="ad";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.qqrob.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.qqrob.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.qqrob.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.qqrob.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qqrob.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="6.42";//新版本号 
    ...
    public static String ad="QQ微信抢红包王（100%避免抢最小等强大功能）埋雷避雷牛牛软件。可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/qq.apk";//下载地址
    ...
    public static String warning="警告：未授权用户有中的可能！授权后抢包速度翻倍！";//下载地址 
