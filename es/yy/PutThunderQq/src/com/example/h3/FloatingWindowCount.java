	    ...
	    private void createFloatView()
	  	{
	          ...
	          //获取浮动窗口视图所在布局
	          //mFloatLayout = (LinearLayout) inflater.inflate(com.byc.PutThunderQq.R.layout.float_thunder_count, null);
	          int layoutID=context.getApplicationContext().getResources().getIdentifier("float_thunder_count", "layout",context.getPackageName());
	          ...
	          //mFloatLayout.
	          //tvShow.getTransitionName()
	          //tv0 = (TextView)mFloatLayout.findViewById(R.id.tv0);
	          tv0 = (TextView)mFloatLayout.getChildAt(1);
	          //tv1 = (TextView)mFloatLayout.findViewById(R.id.tv1);
	          tv1 = (TextView)mFloatLayout.getChildAt(2);
	          tv2 = (TextView)mFloatLayout.getChildAt(3);
	          tv3 = (TextView)mFloatLayout.getChildAt(4);
	          tv4 = (TextView)mFloatLayout.getChildAt(5);
	          tv5 = (TextView)mFloatLayout.getChildAt(6);
	          tv6 = (TextView)mFloatLayout.getChildAt(7);
	          tv7 = (TextView)mFloatLayout.getChildAt(8);
	          tv8 = (TextView)mFloatLayout.getChildAt(9);
	          tv9 = (TextView)mFloatLayout.getChildAt(10);
	          
	          tvHide = (TextView)mFloatLayout.getChildAt(11);
	          bindWidget();
	          //添加mFloatLayout
