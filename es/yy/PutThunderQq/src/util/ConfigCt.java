...
public class ConfigCt {
	...
	public static final String appID="ab";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.qqputthunder.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //public static final String FTP_FILE_NAME="qqputthunder01.xml";//服务器上文件名；
    ...
    public static String ad="排雷专家（100%避雷）埋雷专家软件（埋几个雷就出几QQ个）。可试用。";//广告语
    ...
    public static String warning="警告：未授权用户出雷机率在0~5个之间！授权后埋几个雷就出几个！";//下载地址  
	...
	public static int OtherMediaSendADinterval=20000;//最大已注册对其它媒体发广告间隔； 
