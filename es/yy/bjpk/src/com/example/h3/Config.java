...
public class Config {
	...
	public static final String PREFERENCE_NAME = "byc_bjpk_config";//配置文件名称
	...
	//定义app标识
	public static final String appID="av";//定义app标识：北京PK
    //服务器IP
    ...
    //-------------------------------------------------------------------------------------------------------
    public static final String ACTION_CALC_DELAY = "com.byc.bjpk.Calc_DELAY ";//计算延时消息
    public static final String ACTION_CALC_SHOW = "com.byc.bjpk.Calc_SHOW ";//计算显示消息
    //--------------------------------------------------------------------------------------------------------
    ...
    public static int iHaopai=HAO_PAI_50;//--好牌机率10
    
    

  //游戏包名：
    public static final String GAME_PACKAGE_BROWSER="com.android.browser";//-- 浏览器游戏；
    public static final String GAME_PACKAGE_ZHUANGYUAN="com.ScholarSMP";//-- 状元彩票网；
	public static final String GAME_PACKAGE = "Game_Package";//存储游戏包名；
    //public static String GamePackage="com.android.browser,com.tencent.mm";//-- 游戏包名全局变量；
    public static String GamePackage="com.android.browser";//-- 游戏包名全局变量；
	//微信的包名
	//微信的包名
    ...
    //网址：
	private static final String GAME_ADDR= "Game_Addr";//存储游戏地址；
    private static final String SEL_GAME_ADDR_INDEX="Sel_Game_Addr_Index";//--所选择 的游戏地址存储
    public static int GameAddrIndex=0;//--所选择 的游戏地址存储
    public static String GameAddr="";//--所选择 的游戏地址存储
    //游戏名称：
    ...
    //投注方式：
    public static final String GAME_BET_WAY= "Game_Bet_Way";//存储游戏投注方式；
    public static String GameBetWay=null;//-- 游戏投注方式全局变量；
    private static final String SEL_GAME_BET_WAY_INDEX="Sel_Game_Index";//--所选择 的游戏投注方式存储
    //其它：
    public static int iSelGameBetWay=0;//--选择的游戏投注方式编号;
    public static final String PLAYER_ID= "Player_ID";//存储游戏玩家ID；
    public static String PlayerID="";//-- 游戏玩家全局变量；
    //全局变量：
