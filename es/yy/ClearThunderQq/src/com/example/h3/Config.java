...
public class Config {
	...
	//定义app标识
	public static final String appID="ai";//定义app标识：ah排雷专家可试用
    //服务器IP
    ...
    public static final int KEY_THUNDER_IS_SAY=4;//红包语既是雷；
    ...
    public static final int KEY_THUNDER_ANY=10;//--雷
    ...
    public static final String ACTION_CLICK_LUCKY_MONEY = "com.byc.qqclearthunder.CLICK_LUCKY_MONEY";//抢包消息
    public static final String ACTION_DISPLAY_SUCCESS= "com.byc.qqclearthunder.ACTION_DISPLAY_SUCCESS";//避雷成功消息
    public static final String ACTION_DISPLAY_FAIL= "com.byc.qqclearthunder.ACTION_DISPLAY_FAIL";//避雷失败消息
    
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.qqclearthunder.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.qqclearthunder.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.qqclearthunder.CMD_INFO ";//root命令消息
