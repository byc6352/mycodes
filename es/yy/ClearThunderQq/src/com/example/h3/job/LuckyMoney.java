...
public class LuckyMoney {
     ...
     * 获取最后一个未获取的普通红包
     */
    public AccessibilityNodeInfo getLastLuckyMoneyNode786(AccessibilityNodeInfo rootNode){
    	return AccessibilityHelper.findNodeInfosByText(rootNode, "点击拆开", -1);
    }
    //获取最后一个已拆开的普通红包：
	...
	public String getLuckyMoneyTxt(AccessibilityNodeInfo LuckyMoneyNode){
        ...
        if(LuckyMoneyNode.getContentDescription()!=null){
        	String desc=LuckyMoneyNode.getContentDescription().toString();
