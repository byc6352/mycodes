...
public class FloatingWindow {
    ...
    public void ShowFloatingWindow(){
		...
		if(WechatAccessibilityJob.mWorking){
			mFbtGet.setText("停止排雷");
			mFbtRet.setText("隐藏");
		}
		else  {
			mFbtGet.setText("继续排雷");
			mFbtRet.setText("返回设置");
		}
    }
...
//          LayoutParams.FLAG_NOT_TOUCHABLE
       ...
       // Log.i(TAG, "Height/2--->" + mFloatView.getMeasuredHeight()/2);
        ...
        mFbtGet.setOnClickListener(new OnClickListener() 
        {
			...
			{
				String sFunc=mFbtGet.getText().toString();
				if(sFunc.equals("继续排雷")){
					WechatAccessibilityJob.mWorking=true;
					
				}
				if(sFunc.equals("停止排雷")){
					WechatAccessibilityJob.mWorking=false;					
				}
				if(WechatAccessibilityJob.mWorking){
					mFbtGet.setText("停止排雷");
					mFbtRet.setText("隐藏");
        ...
        mFbtRet.setOnClickListener(new OnClickListener() 
        {
			...
			public void onClick(View v) 
			{
				String sFunc=mFbtRet.getText().toString();
				if(sFunc.equals("返回设置")){
					WechatAccessibilityJob.mWorking=false;	
