...
public class ConfigCt {
    ...
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.qqclearthunder.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="qqclearthunder.xml";//服务器上文件名；
    private static final String INFO_NEW_VERSION="Info_New_Version";//--新版本 号
    public static String  new_version="6.95";//新版本号 
    ...
    public static String download="http://119.23.68.205/android/clearthunderqq.apk";//下载地址
