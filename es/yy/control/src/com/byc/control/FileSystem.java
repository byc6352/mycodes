...
import com.byc.control.MainService.DataThread;
import com.byc.control.MainService.DataThreadInfo;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					DataThread dataThread=MainService.getOrderService().getDataThread();
