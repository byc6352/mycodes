...
public class Config {
	...
	public static final String WECHAT_PACKAGENAME = "com.tencent.mobileqq";
	   /** 要求的QQ最大版本号 */
	public static final int NEED_QQ_MAX_VERSION = 450;//
	public static final String NEED_QQ_MAX_VERSION_S = "6.6.2";
    ...
    public static final int KEY_THUNDER_ANY=10;//--雷数不定
    ...
    public static final String ACTION_CLICK_LUCKY_MONEY = "com.byc.qqclearthunder2.CLICK_LUCKY_MONEY";//抢包消息
    public static final String ACTION_DISPLAY_SUCCESS= "com.byc.qqclearthunder2.ACTION_DISPLAY_SUCCESS";//避雷成功消息
    public static final String ACTION_DISPLAY_FAIL= "com.byc.qqclearthunder2.ACTION_DISPLAY_FAIL";//避雷失败消息
    ...
    public static boolean bSpeaking=KEY_SPEAKING;//--默认发音
	   ...
	   private static Config current;
	    ...
	    public int getThunderNum() {
	        return preferences.getInt(THUNDER_NUM, 0);
	    }
