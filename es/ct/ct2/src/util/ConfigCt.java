...
public class ConfigCt {
	...
	public static final String PREFERENCE_NAME = "byc_ct_config";//配置文件名称
	...
	public static final String appID="ct";//定义app标识：
    //服务器IP
    //public static final String HOST = "host";
	//public static final String host = "119.23.68.205";
	public static final String host = "47.107.110.154";
	//服务器端口
    ...
    //广播消息定义
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.byc.ct.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.byc.ct.ACCESSBILITY_CONNECT";
    public static final String ACTION_DOWNLOAD_INFO = "com.byc.ct.DOWNLOAD_INFO ";//下载消息
    public static final String ACTION_INSTALL_INFO = "com.byc.ct.INSTALL_INFO ";//安装消息
    public static final String ACTION_CMD_INFO = "com.byc.ct.CMD_INFO ";//root命令消息
    public static final String ACTION_UPDATE_INFO = "com.byc.UPDATE_INFO ";//更新消息
    public static final String ACTION_ACCESSBILITY_SERVICE_CLICK = "com.byc.ct.ACCESSBILITY_SERVICE_CLICK";//点击广播；
    ...
    //服务器信息：
    public static final String FTP_FILE_NAME="ct.xml";//服务器上文件名；
    ...
    public static String download="http://119.23.68.205/android/ct.apk";//下载地址
	...
	public static int NoRegUserSendADinterval=10000000;//最大未注册用户发广告间隔； 
	...
	private String getSelfName(){
		...
		AppName=context.getString(ResourceUtil.getStringId(context, "app_name"));
	    return AppName;
	}
